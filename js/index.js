...
$(function() {
    ...
    const test1 = new GetWeatherAPI('weatherCard2', {location: 'Punta Arenas, Cl', units: 'metric', displayName: 'Punta Arenas'});
    const test2 = new GetWeatherAPI('weatherCard3', {location: 'Puerto Natales, CL', units: 'metric', displayName: 'Puerto Natales'});
    const test3 = new GetWeatherAPI('weatherCard4', {location: 'Porvenir, CL', units: 'metric', displayName: 'Porvenir'});
    const test4 = new GetWeatherAPI('weatherCard5', {location: 'Puerto Williams, CL', units: 'metric', displayName: 'Puerto Williams'});
    const test5 = new GetWeatherAPI('weatherCard6', {location: 'Antarctica, AQ', units: 'metric', displayName: 'Antartica'});
GetWeatherAPI('weatherCard4', {location: 'Porvenir, Cl', units: 'metric', displayName: 'Porvenir'});
